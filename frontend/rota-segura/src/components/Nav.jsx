            ...
            <nav className="bg-gray-100">
                <div className="flex justify-between items-center max-w-7xl mx-auto px-4 py-2">
                    ...
                    <Link to="/rota-segura/login">
                        <div className='flex items-center gap-1 border border-gray-200 rounded-full px-5 py-2 shadow-sm bg-white max-sm:ml-10'>
                            ...
                            <p className='max-sm: truncate'>Ana Paula de</p>
                        </div>
                    </Link>
                </div>
            </nav>
