                    ...
                    <div className='max-w-6xl mx-auto py-[120px] max-xl:max-w-3xl  max-md:max-w-[600px] ' >
                        ...
                        <div className='py-10 max-sm:py-3'>
                            <Link to="/rota-segura/buscar">
                                <button className='bg-central cursor-pointer rounded-full px-11 py-4 shadow-lg hover:bg-yellow-600 hover:text-white shadow-neutral-400 max-sm:px-7 max-sm:py-5'>Buscar rotas</button>
                            </Link>
                        </div>
                    </div>
                </div>
